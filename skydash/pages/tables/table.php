...
<form method="post" action="table.php">
    <div class="modal-body">
        ...
        <input type="text" name="keterangan" value="<?php echo $keterangan; ?>" placeholder="Keterangan" class="form-control" required><br>
...
<script>
  $(document).ready(function() {
    $('.edit-button').click(function() {
      ...
      var gambar = $(this).closest('tr').find('td:nth-child(8)').text();
var imgElement = $('<img>').attr('src', 'data:image/jpeg;base64,' + gambar);
