...
<body>
              ...
              <div class="content-wrapper">
                <div class="row">
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h4 class="card-title">Tabel Surat Disposisi</h4>
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalDisposisi">
                          Disposisi Baru
                        </button>
                        <div class="table-responsive">
                          <table class="table">
                            ...
                            <tbody>
                              <?php
                              $dataDisposisi = mysqli_query($conn, "select * from disposisi JOIN surat ON disposisi.id_surat=surat.id_surat");
                              $i = 1;
                              while($data=mysqli_fetch_array($dataDisposisi)){
  ...
  <!-- End custom js for this page-->
    ...
    <!-- The Modal 2-->
<div class="modal fade" id="myModalDisposisi">
    <div class="modal-dialog">
      ...
      <form method="post">
        ...
        <button type="submit" class="btn btn-primary" name="disposisiBaru">Submit</button>
        </div>
      </form>
  ...
  <!-- The Modal -->
<div class="modal fade" id="editD">
    <div class="modal-dialog">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Edit Data Disposisi</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
...
<div class="modal fade" id="deleteD<?php echo $id_disposisi; ?>">
    <div class="modal-dialog">
      <div class="modal-content">
        <!-- Modal Header -->
        <div class="modal-header">
        ...
        <div class="modal-footer">
          <form method="POST">
            <input type="hidden" name="id_disposisi" value="<?php echo $id_disposisi; ?>">
            <button type="submit" class="btn btn-danger" name="hapusDisposisi">Hapus</button>
