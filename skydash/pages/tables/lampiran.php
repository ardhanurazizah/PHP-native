                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                      <?php
                        $dataLampiran = mysqli_query($conn, "select * from lampiran JOIN surat ON lampiran.id_surat=surat.id_surat");
                        $nomorUrut = 1;
                        while($data=mysqli_fetch_array($dataLampiran)){
                          $i = 1;
                          $id_lampiran = $data['id_lampiran'];
                          $keterangan = $data['keterangan'];
                          $deskripsi_lampiran = $data['deskripsi_lampiran'];
                        ?>
                        <tr>
...
<div class="modal fade" id="myModal4">
    <div class="modal-dialog">
      ...
      <form method="post">
        ...
        <input type="text" name="deskripsi_lampiran" placeholder="deskripsi_lampiran" class="form-control" required><br>
        <button type="submit" class="btn btn-primary" name="lampiranBaru">Submit</button>
        </div>
      </form>
...
<div class="modal fade" id="deleteLampiran<?php echo $id_lampiran; ?>">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Body -->
        <div class="modal-body">
          <p>Anda yakin ingin menghapus data lampiran ini?</p>
        </div>
        <!-- Modal Footer -->
        <div class="modal-footer">
          <form method="POST">
            <input type="hidden" name="id_lampiran" value="<?php echo $id_lampiran; ?>">
            <button type="submit" class="btn btn-danger" name="hapusLampiran">Hapus</button>
