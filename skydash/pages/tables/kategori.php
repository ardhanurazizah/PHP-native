...
<div class="modal fade" id="myModal2">
    <div class="modal-dialog">
      ...
      <form method="post">
        ...
        <input type="text" name="nama_kategori" placeholder="Kategori" class="form-control" required><br>
        <button type="submit" class="btn btn-primary" name="kategoriBaru">Submit</button>
        </div>
      </form>
