...
function getAdminDataByUsername($conn, $email)
{
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $adminData = getAdminDataByUsername($conn, $email);
    ...
    if ($adminData) {
        ...
        if (verifyPassword($password, $adminData['password'])) {
            ...
            header("Location: pages/tables/table.php");
            exit;
        } else {
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" method="post" action="table.php">
                ...
                <div class="mt-3">
                  <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" name="login" href="pages/tables/table.php">LOGIN</a>
                </div>
