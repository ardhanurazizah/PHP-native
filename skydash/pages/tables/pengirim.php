        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tabel Pengirim</h4>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                        $dataPengirim = mysqli_query($conn, "select * from pengirim");
                        $nomorUrut = 1;
                        while($data=mysqli_fetch_array($dataPengirim)){
                          $i = 1;
                                                ...
                                                <!-- Modal body -->
                                                    <form method="POST">
                                                        <div class="modal-body">
                                                            Anda yakin ingin menghapus data ini ? <?php echo $id_pengirim;?>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
      ...
      <form method="post">
        <div class="modal-body">  
        <input type="text" name="nama_pengirim" placeholder="Nama Pengirim" class="form-control" required><br>
        ...
        <button type="submit" class="btn btn-primary" name="pengirimBaru">Submit</button>
        </div>
      </form>
  ...
  <!-- The Modal -->
<div class="modal fade" id="editPengirim">
    <div class="modal-dialog">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Edit Data Pengirim</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <!-- Modal body -->
<form method="post" action="pengirim.php">
    <div class="modal-body">
        <input type="hidden" name="id_pengirim" value="<?php echo $id_pengirim; ?>">
        <input type="text" name="nama_pengirim" value="<?php echo $nama_pengirim; ?>" placeholder="Nama Pengirim" class="form-control" required><br>
        <input type="text" name="jabatan" value="<?php echo $jabatan; ?>" placeholder="Jabatan" class="form-control" required><br>
        <input type="text" name="alamat" value="<?php echo $alamat; ?>" placeholder="Alamat" class="form-control" required><br>
        <button type="submit" class="btn btn-primary" name="updatePengirim">Update</button>
    </div>
</form>
